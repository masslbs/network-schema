...
func TestGenerateVectorsUserFlows(t *testing.T) {
	...
	userStories := []struct {
		...
		{"ComplexOrderWithVariations", complexOrderWithVariationsStory},
...
func complexOrderWithVariationsStory(t *testing.T, vectors *vectorFileOkay) {
	// Similar structure to simpleShoppingTripStory but with:
	// - Multiple items in cart
	// - Different variations selected
