...
const file_shop_requests_proto_rawDesc = "" +
	"\n" +
	"\x13shop_requests.proto\x12\vmarket.mass\"\x19\n" +
	"\x17GetBlobUploadURLRequestb\x06proto3"

var (
	file_shop_requests_proto_rawDescOnce sync.Once
	file_shop_requests_proto_rawDescData []byte
)

func file_shop_requests_proto_rawDescGZIP() []byte {
	file_shop_requests_proto_rawDescOnce.Do(func() {
		file_shop_requests_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_shop_requests_proto_rawDesc), len(file_shop_requests_proto_rawDesc)))
	})
...
func file_shop_requests_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_shop_requests_proto_rawDesc), len(file_shop_requests_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
