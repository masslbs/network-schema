...
class SubscriptionRequest(_message.Message):
    ...
    class Filter(_message.Message):
        ...
        def __init__(self, object_type: _Optional[_Union[ObjectType, str]] = ..., object_id: _Optional[_Union[_base_types_pb2.ObjectId, _Mapping]] = ...) -> None: ...
...
class SubscriptionPushRequest(_message.Message):
    ...
    class SequencedPartialPatchSet(_message.Message):
        __slots__ = ("shop_seq_no", "patch_leaf_index", "header", "signature", "patches", "proofs")
        ...
        def __init__(self, shop_seq_no: _Optional[int] = ..., patch_leaf_index: _Optional[int] = ..., header: _Optional[bytes] = ..., signature: _Optional[bytes] = ..., patches: _Optional[_Iterable[bytes]] = ..., proofs: _Optional[_Iterable[bytes]] = ...) -> None: ...
    SUBSCRIPTION_ID_FIELD_NUMBER: _ClassVar[int]
    SETS_FIELD_NUMBER: _ClassVar[int]
    subscription_id: bytes
    sets: _containers.RepeatedCompositeFieldContainer[SubscriptionPushRequest.SequencedPartialPatchSet]
    def __init__(self, subscription_id: _Optional[bytes] = ..., sets: _Optional[_Iterable[_Union[SubscriptionPushRequest.SequencedPartialPatchSet, _Mapping]]] = ...) -> None: ...
