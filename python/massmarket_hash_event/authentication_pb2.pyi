...
class AuthenticateRequest(_message.Message):
    ...
    def __init__(self, public_key: _Optional[_Union[_base_types_pb2.PublicKey, _Mapping]] = ...) -> None: ...
...
class AuthenticateResponse(_message.Message):
    ...
    challenge: bytes
    def __init__(self, error: _Optional[_Union[_error_pb2.Error, _Mapping]] = ..., challenge: _Optional[bytes] = ...) -> None: ...

class ChallengeSolvedRequest(_message.Message):
    __slots__ = ["signature"]
    SIGNATURE_FIELD_NUMBER: _ClassVar[int]
    signature: _base_types_pb2.Signature
    def __init__(self, signature: _Optional[_Union[_base_types_pb2.Signature, _Mapping]] = ...) -> None: ...
