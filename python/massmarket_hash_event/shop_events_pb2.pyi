...
class UpdateShopManifest(_message.Message):
    __slots__ = ["event_id", "name", "description", "profile_picture_url", "domain", "published_tag_id", "add_payee", "remove_payee", "add_accepted_currencies", "remove_accepted_currencies", "set_base_currency"]
    ...
    add_accepted_currencies: _containers.RepeatedCompositeFieldContainer[_shop_pb2.ShopCurrency]
    remove_accepted_currencies: _containers.RepeatedCompositeFieldContainer[_shop_pb2.ShopCurrency]
    set_base_currency: _shop_pb2.ShopCurrency
    def __init__(self, event_id: _Optional[bytes] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., profile_picture_url: _Optional[str] = ..., domain: _Optional[str] = ..., published_tag_id: _Optional[bytes] = ..., add_payee: _Optional[_Union[UpdateShopManifest.Payee, _Mapping]] = ..., remove_payee: _Optional[_Union[UpdateShopManifest.Payee, _Mapping]] = ..., add_accepted_currencies: _Optional[_Iterable[_Union[_shop_pb2.ShopCurrency, _Mapping]]] = ..., remove_accepted_currencies: _Optional[_Iterable[_Union[_shop_pb2.ShopCurrency, _Mapping]]] = ..., set_base_currency: _Optional[_Union[_shop_pb2.ShopCurrency, _Mapping]] = ...) -> None: ...
