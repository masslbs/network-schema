...
publishItem.action = store_events_pb2.UpdateTag.ACTION_ADD_ITEM
...
unpublishItem.action = store_events_pb2.UpdateTag.ACTION_REMOVE_ITEM
...
# open cart
cart1 = store_events_pb2.CreateCart()
cart1.event_id = random.randbytes(32)
events.append(cart1)

atc1 = store_events_pb2.ChangeCart()
...
# cart to be payed
cart2 = store_events_pb2.CreateCart()
cart2.event_id = random.randbytes(32)
events.append(cart2)

atc2 = store_events_pb2.ChangeCart()
...
commit_cart = store_events_pb2.CartFinalized()
...
payedCart = store_events_pb2.ChangeStock(item_ids=[newItem.event_id], diffs=[-42])
...
cart3 = store_events_pb2.CreateCart()
cart3.event_id = random.randbytes(32)
events.append(cart3)

atc3 = store_events_pb2.ChangeCart()
...
commit_cart3 = store_events_pb2.CartFinalized()
...
cart_abandoned = store_events_pb2.CartAbandoned()
...
cart4 = store_events_pb2.CreateCart()
...
commit_cart4 = store_events_pb2.CartFinalized()
...
for idx, evt in enumerate(events):
  ...
  if type_name == "StoreManifest":
    wrapped = store_events_pb2.Event(store_manifest=evt)
  elif type_name == "UpdateStoreManifest":
    wrapped = store_events_pb2.Event(update_store_manifest=evt)
  elif type_name == "CreateItem":
    wrapped = store_events_pb2.Event(create_item=evt)
  elif type_name == "UpdateItem":
    wrapped = store_events_pb2.Event(update_item=evt)
  elif type_name == "CreateTag":
    wrapped = store_events_pb2.Event(create_tag=evt)
  elif type_name == "UpdateTag":
    wrapped = store_events_pb2.Event(update_tag=evt)
  elif type_name == "NewKeyCard":
    wrapped = store_events_pb2.Event(new_key_card=evt)
  elif type_name == "ChangeStock":
    wrapped = store_events_pb2.Event(change_stock=evt)
  elif type_name == "CreateCart":
    wrapped = store_events_pb2.Event(create_cart=evt)
  elif type_name == "ChangeCart":
    wrapped = store_events_pb2.Event(change_cart=evt)
  elif type_name == "CartFinalized":
    wrapped = store_events_pb2.Event(cart_finalized=evt)
  elif type_name == "CartAbandoned":
    wrapped = store_events_pb2.Event(cart_abandoned=evt)
  else:
