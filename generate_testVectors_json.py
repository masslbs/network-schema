...
order_open_item = mtypes.OrderedItem(listing_id=listing_simple.id, quantity=23)
...
order_paid_item = mtypes.OrderedItem(listing_id=listing_simple.id, quantity=42)
