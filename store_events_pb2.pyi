...
class UpdateTag(_message.Message):
    ...
    class TagAction(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
        ACTION_UNSPECIFIED: _ClassVar[UpdateTag.TagAction]
        ACTION_ADD_ITEM: _ClassVar[UpdateTag.TagAction]
        ACTION_REMOVE_ITEM: _ClassVar[UpdateTag.TagAction]
        ACTION_RENAME: _ClassVar[UpdateTag.TagAction]
        ACTION_DELETE_TAG: _ClassVar[UpdateTag.TagAction]
    ACTION_UNSPECIFIED: UpdateTag.TagAction
    ACTION_ADD_ITEM: UpdateTag.TagAction
    ACTION_REMOVE_ITEM: UpdateTag.TagAction
    ACTION_RENAME: UpdateTag.TagAction
    ACTION_DELETE_TAG: UpdateTag.TagAction
    EVENT_ID_FIELD_NUMBER: _ClassVar[int]
    TAG_ID_FIELD_NUMBER: _ClassVar[int]
